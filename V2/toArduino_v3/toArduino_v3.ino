...
void loop() {
  ...
  espPin.print(pHLevel, 2);            espPin.print("I"); 
  espPin.print("\n");

  ////////////////////////
  Serial.print(plantMoistureA);        Serial.print("A"); 
  Serial.print(plantMoistureB);        Serial.print("B");
  Serial.print(plantMoistureC);        Serial.print("C");

  Serial.print(humidity);              Serial.print("D");
  Serial.print(temperature);           Serial.print("E");

  Serial.print(mixContainerLevel);     Serial.print("F");
  Serial.print(alkContainerLevel);     Serial.print("G");
  Serial.print(aciContainerLevel);     Serial.print("H");

  Serial.print(pHLevel, 2);            Serial.print("I"); 
  Serial.print("\n");
